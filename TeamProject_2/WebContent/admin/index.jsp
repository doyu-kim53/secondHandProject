<%@page import="com.gaji.dongnae.vo.MemberVO"%>
...
<!--                                     <span class="arrow_carrot-down"></span> -->
                    ...
                    <div class="hero__item set-bg" data-setbg="${pageContext.request.contextPath}/img/hero/banner.jpg" onclick="${pageContext.request.contextPath}/boardcontrol?type=writeboard&ok=no" id="backbanner">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="${pageContext.request.contextPath}/boardcontrol?type=start"><img src="${pageContext.request.contextPath}/img/logo.png" alt="" width="100"></a>
                        </div>
                        <ul>
                            <li>Address: 서울시 강남구 역삼동</li>
