package com.gaji.admin.common;

//페이징 처리할때 필요한 데이터들을 저장해놓고 필요할때마다 가져다쓰는 클래스
public class Paging {
	...
	private int begin = 0; //현재 페이지상의 시작 번호(글번호와는 무관)
	private int end = 0; //현재 페이지상의 마지막 번호(글번호와는 무관)
	...
	public void setTotalPage() {
		totalPage = totalRecord / numPerPage; // == totalRecord % numPerPage
	...
	public void setNomBlock(int nowBlock) {
	...
	public String toString() {
		return "Paging [nowPage=" + nowPage + ", nowBlock=" + nowBlock + ", numPerPeage=" + numPerPage
