...
public class QnaWriteCommandOk implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String qnaImgPath1 = mr.getFilesystemName("file1");						
		...
		if (qnaImgPath1 != null) {
			realImgName.append(qnaImgPath1);
			realImgName.append(" ");				
		}
		if (qnaImgPath2 != null) {
			realImgName.append(qnaImgPath2);
			realImgName.append(" ");				
		}
		if (qnaImgPath3 != null) {
			realImgName.append(qnaImgPath3);
			realImgName.append(" ");				
		}
